...
(function () {
    ...
    window.MT_Core = {
        ...
        calculateMCMV: function (renda, dividas, fgts, entrada, temDependentes, clt3anos, ePrimeiroImovel) {
            ...
            // O cliente deve cobrir no mínimo a entrada exigida pelo banco, MAS também deve absorver qualquer 
            // diferença de arredondamento do valor do imóvel para que a parcela não estoure a margem de 30% do banco.
