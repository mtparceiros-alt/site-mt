...
(function () {
    ...
    var contentImg, contentBadge, contentTitle, contentPrice, contentSpecs, contentDesc, inlineCalendar, contentDNA;
    ...
    function init() {
        ...
        contentDNA = drawer.querySelector('.ma-drawer-dna-container');
    ...
    function injectHTML() {
        ...
        var html = '<div id="ma-drawer-backdrop" class="ma-drawer-backdrop"></div>' +
            ...
            '      </div>' +
            '      <div class="ma-drawer-dna-container"></div>' +
            '    </div>' +
            '  </div>' +
    ...
    function openDrawer(nome) {
        ...
        // 🧬 Renderiza o Módulo DNA (Dossiê Técnico) abaixo do mapa
        if (contentDNA && window.MT_Utils && window.MT_Utils.getDNAHtml) {
            contentDNA.innerHTML = window.MT_Utils.getDNAHtml(emp.nome);
        }
