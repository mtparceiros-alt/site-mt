...
(function () {
    ...
    function init() {
        ...
        document.addEventListener('click', function (e) {
            ...
            if (target && target.dataset.empNome) {
                e.preventDefault();
                e.stopImmediatePropagation(); // Evita que outros scripts (como o modal antigo) abram
    ...
    function renderCalendar(date) {
        ...
        prev.innerHTML = '&lt;';
        prev.onclick = function () { currentCalendarDate.setMonth(month - 1); renderCalendar(currentCalendarDate); };
        ...
        next.innerHTML = '&gt;';
        next.onclick = function () { currentCalendarDate.setMonth(month + 1); renderCalendar(currentCalendarDate); };
