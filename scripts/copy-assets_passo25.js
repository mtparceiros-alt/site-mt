...
const SENSITIVE_JS_ORIGINAIS = new Set([
  'simulator-core.js',
  'index-logic.js',
  'score-module.js',
  'score-melhorias.js',
...
function processarHTML() {
  const paginas = ['index.html', 'properties.html', 'property-details.html', 'contato.html', 'simulador.html', 'preview-results.html'];
...
function copiarJsAuxiliares() {
  ...
  arquivos.forEach((arquivo) => {
    ...
    if (SENSITIVE_JS_ORIGINAIS.has(arquivo)) return;
